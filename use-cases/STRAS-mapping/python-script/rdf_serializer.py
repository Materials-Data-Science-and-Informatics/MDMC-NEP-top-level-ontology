...
def rdf_serializer(iri):
    ...
    g.add((VT_STM_Microscopy, RDF.type, EXP.Instrument))
    g.add((analysis_software, RDF.type, DAL.ResearchSoftware))
    ...
    g.add((STM_experiment_1998, RDF.type, CORE.Experiment))
    STM_experiment_2010 = example['STM_experiment_2010']
    g.add((STM_experiment_2010, RDF.type, CORE.Experiment))
    g.add((study_1, RDF.type, CORE.Study))
    g.add((study_1, CORE.hasExperiment, STM_experiment_1998))
    ...
    g.add((study_2, CORE.hasExperiment, STM_experiment_2010))
    ...
    g.add((STM_experiment_1998, EXP.hasMeasurement, VT_STM_meas_1998_1))
    g.add((STM_experiment_1998, EXP.hasMeasurement, VT_STM_meas_1998_2))
    ...
    g.add((sputter_gun_1, RDF.type, EXP.Equipment))
    g.add((heating_stage_1,RDF.type, EXP.Equipment))
    g.add((ethylene_1,RDF.type, EXP.SampleComponent))
    g.add((gas_line_1,RDF.type, EXP.Equipment))
    g.add((LEED_instrument, RDF.type, EXP.Instrument))
    ...
    g.add((Graphene_growth_sample_preparation, EXP.usesEquipment, sputter_gun_1))
    g.add((Graphene_growth_sample_preparation, EXP.usesEquipment, heating_stage_1))
    g.add((Graphene_growth_sample_preparation, EXP.usesEquipment, gas_line_1))
    g.add((sample_quality_check_1, EXP.usesEquipment, LEED_instrument))
    g.add((sample_quality_check_1, PMD.input, graphene_Ni_sample))
    g.add((VT_STM_meas_1998_1, PMD.input, graphene_Ni_sample))
    g.add((STM_experiment_1998, EXP.hasSamplePreparation, Graphene_growth_sample_preparation))    
